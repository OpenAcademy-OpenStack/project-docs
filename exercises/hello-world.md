1. Get familiarized with Cloud principles. Let us use AWS EC2 as the first example. If you're already familiar with EC2 and have built apps on cloud, then move on to Step 2.
