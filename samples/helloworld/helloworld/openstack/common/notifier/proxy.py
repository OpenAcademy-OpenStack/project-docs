...
"""
A temporary helper which emulates helloworld.messaging.Notifier.

This helper method allows us to do the tedious porting to the new Notifier API
as a standalone commit so that the commit which switches us to helloworld.messaging
...
from helloworld.openstack.common.notifier import api as notifier_api
